...
#define PROTOCOL_SLAVE_DY               0x02                        // 动态摄像头从机地址
#define PROTOCOL_SLAVE_ADDR_DEFAULT     PROTOCOL_SLAVE_STATIC       // 默认从机地址
...
#if(CONTEXT == 1)
#define PIC_DIR_PATH                    "/Users/xiangpengle/CLionProjects/hd_camera/test/crop_images"
#elif
#define PIC_DIR_PATH                  "/userdata/crop_images"
#endif
